...
class Medico {
   ...
   public static function selectAll($id = null) {
     ...
     $sql = sprintf("SELECT id, queixa, p_renal, p_articular, p_cardiaco, p_respiratorio, p_gastrico, p_cicatrizar, alergias, hepatite, gravidez, diabetes, medicamentos, agendamento_id FROM atendimentos %s ORDER BY id ASC", $where);
     ...
     */
    public static function save($id, $queixa, $p_renal, $p_articular, $p_cardiaco, $p_respiratorio, $p_gastrico, $p_cicatrizar, $alergias, $hepatite, $gravidez, $diabetes, $medicamentos, $agendamento_id)
    {
        ...
        (queixa, p_renal, p_articular, p_cardiaco, p_respiratorio, p_gastrico, p_cicatrizar, alergias, hepatite, gravidez, diabetes, medicamentos, agendamento_id)
         VALUES(:queixa, :p_renal, :p_articular, :p_cardiaco, :p_respiratorio, :p_gastrico, :p_cicatrizar,:alergias, :hepatite, :gravidez, :diabetes, :medicamentos, :agendamento_id)";
          $stmt = $DB->prepare($sql);
