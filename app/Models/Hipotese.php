...
class Hipotese {
   ...
   public static function selectAll($id = null) {
     ...
     $sql = sprintf("SELECT id, hipotese, observacoes,agendamento_id FROM hipoteses ORDER BY id ASC", $where);
     $DB = new DB; $stmt = $DB->prepare($sql);
        ...
        $hipoteses = $stmt->fetchAll(\PDO::FETCH_ASSOC);
     ...
     */
    public static function save($hipotese, $observacoes,$agendamento_id)
    {
        ...
        // insere no banco
        $DB = new DB;
        $sql = "INSERT INTO hipoteses
        (hipotese, observacoes,agendamento_id)
         VALUES(:hipotese, :observacoes ,:agendamento_id)";
          $stmt = $DB->prepare($sql);
