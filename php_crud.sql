...
--
-- Host: localhost:3306
-- Generation Time: 04-Dez-2017 às 10:42
...
INSERT INTO `agendamento` (`id`, `data`, `hora`, `idclient`, `idmedico`) VALUES
(3, '27/11/2017', '09:24', 1, 2),
(4, '28/11/2017', '21:38', 1, 2),
(5, '29/11/2017', '16:25', 2, 2),
(6, '29/11/2017', '16:00', 3, 2),
(7, '29/11/2017', '21:32', 2, 2);
...
CREATE TABLE `atendimentos` (
  ...
  `p_renal` varchar(255) NOT NULL,
  `p_articular` varchar(255) NOT NULL,
  `p_cardiaco` varchar(255) NOT NULL,
  `p_respiratorio` varchar(255) NOT NULL,
  `p_gastrico` varchar(255) NOT NULL,
  `p_cicatrizar` tinyint(1) NOT NULL,
  `alergias` varchar(255) NOT NULL,
  `hepatite` tinyint(1) NOT NULL,
  `gravidez` tinyint(1) NOT NULL,
...
INSERT INTO `atendimentos` (`id`, `queixa`, `historico`, `p_renal`, `p_articular`, `p_cardiaco`, `p_respiratorio`, `p_gastrico`, `p_cicatrizar`, `alergias`, `hepatite`, `gravidez`, `diabetes`, `medicamentos`, `agendamento_id`) VALUES
(3, 'sadasdasd', 'asdasdasd', 'asdasdasdsad', 'asdasdasdasd', 'asdasdasdasdasd', 'asdasdasdasdasd', 'asdasdsadasdasd', 1, 'asdasdsadasd', 0, 1, 0, 'asdasdasdasdasd', 3),
(4, 'O paciente estÃ¡ se queixando de dores nos rins ', 'O paciente tem histÃ³rico de cÃ¢ncer nos rins na famÃ­lia. ', 'Problemas renais no inicio as dores comeÃ§aram hÃ¡ algumas semanas', 'NÃ£o', 'NÃ£o', 'NÃ£o', 'NÃ£o', 0, 'NÃ£o', 0, 0, 0, 'Tomou alguns dorflex para tentar passar a dor.', 4),
(5, 'asdasdsodfksaÃ§dfksdfksaodfjkosadjfsafjasopdfjsapdofjsaopdfjpsdjfosajdfposajdfoasjdfp', 'dfasdfasdfasdf', 'asdfsadfasdfasdf', 'asdfadsfasdfsadfsadfasdf', 'asdfasdfasdfasdfasdfasdfasdfsadf', 'asdfasdfasdfasdfasdfasdf', 'asdfasdfsadfasdfasdfasdfasdf', 1, 'asdfasdfasdfasdf', 0, 1, 0, 'sadfsdfsadfasdf', 5),
(6, 'O paciente estÃ¡ se queixando de dores nos rins ', 'O paciente tem histÃ³rico de cÃ¢ncer nos rins na famÃ­lia. ', 'Problemas renais no inicio as dores comeÃ§aram hÃ¡ algumas semanas', 'NÃ£o', 'NÃ£o', 'NÃ£o', 'NÃ£o', 1, 'NÃ£o', 0, 1, 0, 'NÃ£o', 6),
(7, 'Verminosenot', 'Sempre tive desde que eu nasci', 'not', 'not', 'not', 'sim, jÃ¡ tive', 'not', 0, 'not', 0, 0, 0, 'chÃ¡ de alho', 7);
...
INSERT INTO `atestado` (`id`, `texto`, `agendamento_id`) VALUES
(3, '4 dias de repolso', 3),
(4, '4 dias de repolso', 4),
(5, '4 dias de repolso', 5),
(6, '4 dias de repolso', 6),
(7, 'nadinha', 7);
...
INSERT INTO `clients` (`idclient`, `nome`, `cpf`, `rg`, `datanascimento`, `naturalidade`, `email`, `telefone`, `celular`, `idcidade`, `cep`, `complemento`, `nomePai`, `nomeMae`, `tipoSangue`, `nacionalidade`) VALUES
(1, 'Elianaia Lima ', '213.132.132-13', '012113531546', '19/07/1998', 'Imperatriz', 'jlucasevangelista@gmail.com', '9935202565', '992310498', 101, '65901-480', 'Rua SimplÃ­cio Moreira', 'Marcelino Santos de Amorim', 'Gerinalva CÃ¢ndido de amorim', 'O+', 'Brasileiro'),
(2, 'JoÃ£o Lucas ', '612.650.523-95', '12312312312', '04/12/1997', 'Imperatriz', 'jlucasevangelista153@gmail.com', '(99) 98220-5165', '992310498', 1218, '65901-490', 'Rua SimplÃ­cio Moreira', 'Marcelino Santos de Amorim', 'Gerinalva CÃ¢ndido de amorim', 'O+', 'Brasileiro');
...
CREATE TABLE `evolucao` (
  `id` int(11) NOT NULL,
  `evolucao` varchar(1000) DEFAULT NULL,
  `agendamento_id` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `evolucao` (`id`, `evolucao`, `agendamento_id`) VALUES
(3, 'O paciente tÃ¡ evoluindo bem', 3),
(4, 'Com esses medicamentos a evoluÃ§Ã£o do paciente serÃ¡ rÃ¡pida', 4),
(5, 'Com esses medicamentos a evoluÃ§Ã£o do paciente serÃ¡ rÃ¡pida', 5),
(6, 'O paciente tÃ¡ evoluindo bem', 6),
(7, 'nÃ£o melhorou', 7);

-- --------------------------------------------------------

--
-- Estrutura da tabela `hipoteses`
--

CREATE TABLE `hipoteses` (
  `id` int(11) NOT NULL,
  `hipotese` varchar(400) DEFAULT NULL,
  `observacoes` varchar(400) DEFAULT NULL,
  `agendamento_id` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Extraindo dados da tabela `hipoteses`
--

INSERT INTO `hipoteses` (`id`, `hipotese`, `observacoes`, `agendamento_id`) VALUES
(3, 'Pode ser gripe', 'Paciente apresenta tosse constante', 3),
(4, 'Pode ser falta de Ã¡gua, pois devido ao trabalho intenso o paciente disse que nÃ£o bebe muita Ã¡gua ', 'Apresenta desidrataÃ§Ã£o', 4),
(5, 'Pode ser gripe asdasdfasssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssss', 'Paciente apresenta tosse constante', 5),
(6, 'Pode ser gripe', 'Paciente apresenta tosse constante', 6),
(7, 'de incidencia, fato gerador', 'apÃ¡tica, amarela de verme, acima do peso', 7);
...
INSERT INTO `medicos` (`idmedico`, `nomeCompleto`, `crm`, `cpf`, `rg`, `datanascimento`, `naturalidade`, `nacionalidade`, `email`, `telefone`, `celular`, `idesp`, `idestado`, `idcidade`, `endereco`, `bairro`, `cep`, `complemento`, `trabalho`) VALUES
(1, 'JoÃ£o Lucas', '333343333333', '213.132.132-13', '012113531546', '04/12/1997', 'Imperatriz', 'Brasileiro', 'jlucasevangelista@gmail.com', '9935202565', '99231049821312', 3, 1, 79, 'Rua Godofredo Viana, 1088', 'Jardim Tropical', '65901-480', '', 'Unihosp'),
(2, 'Elianaia Lima ', '156484651456446521', '608.226.463-07', '12313215645632', '19/07/1998', 'Imperatriz', 'Brasil', 'elianai.costa434@hotmail.com', '', '99981225165', 7, 10, 1218, 'Vila Ipiranga ', 'Cafeteira', '65911-520', 'De frente ao bar ', 'SÃ£o Rafael');
...
INSERT INTO `prescricao` (`id`, `prescricao`, `agendamento_id`) VALUES
(4, 'Multigripe 4x ao dia ', 3),
(5, '4 dias de repouso, 4 doses de dipirona por dia e beber bastante Ã¡gua', 4),
(6, 'Multigripe 4x ao dia ', 5),
(7, 'Multigripe 4x ao dia ', 6),
(8, 'ir no mÃ©dico', 7);
...
INSERT INTO `sinais` (`id`, `data`, `hora`, `altura`, `peso`, `imc`, `temperatura`, `dor`, `agendamento_id`) VALUES
(3, '27/11/2017', '21:36', '1.70', '60.00', '25.00', '35.00', 'NÃ£o apresenta dores', 3),
(4, '28/11/2017', '16:01', '1.80', '65.00', '26.00', '37.00', 'Nos rins', 4),
(5, '29/11/2017', '20:15', '1.70', '65.00', '25.00', '37.00', 'NÃ£o apresenta dores', 5),
(6, '29/11/2017', '20:49', '1.75', '71.00', '24.00', '37.00', 'NÃ£o apresenta dores', 6),
(7, '29/11/2017', '21:35', '1.73', '85.00', '3.00', '37.00', 'not, sÃ³ no dente', 7);
...
(4, 'JoÃ£o Lucas Evangelista C. de Amorim', 'jlucasevangelista153@gmail.com', '4dff1f81de7a6a2e8127a273b1ea8367', 'Admin'),
(5, 'JoÃ£o Lucas Evangelista', 'jlucasevangelista@gmail.com', '4dff1f81de7a6a2e8127a273b1ea8367', 'Medico'),
(6, 'Elianaia Lima Costa', 'elianai.costa434@hotmail.com', '4dff1f81de7a6a2e8127a273b1ea8367', 'Medico'),
(7, 'RociclÃ©ia Bonavindes Silva', 'elianai.costa434@gmail.com', '25f9e794323b453885f5181f1b624d0b', 'medico');
...
--
-- Indexes for table `hipoteses`
--
ALTER TABLE `hipoteses`
  ADD PRIMARY KEY (`id`),
  ADD KEY `agendamento_id` (`agendamento_id`);
...
ALTER TABLE `evolucao`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
--
-- AUTO_INCREMENT for table `hipoteses`
--
ALTER TABLE `hipoteses`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
--
...
--
-- AUTO_INCREMENT for table `sinais`
--
ALTER TABLE `sinais`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
--
...
--
ALTER TABLE `atendimentos`
  ADD CONSTRAINT `atendimentos_ibfk_1` FOREIGN KEY (`agendamento_id`) REFERENCES `agendamento` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Limitadores para a tabela `atestado`
--
ALTER TABLE `atestado`
  ADD CONSTRAINT `atestado_ibfk_1` FOREIGN KEY (`agendamento_id`) REFERENCES `agendamento` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Limitadores para a tabela `evolucao`
--
ALTER TABLE `evolucao`
  ADD CONSTRAINT `evolucao_ibfk_1` FOREIGN KEY (`agendamento_id`) REFERENCES `agendamento` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Limitadores para a tabela `hipoteses`
--
ALTER TABLE `hipoteses`
  ADD CONSTRAINT `hipoteses_ibfk_1` FOREIGN KEY (`agendamento_id`) REFERENCES `agendamento` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Limitadores para a tabela `prescricao`
--
ALTER TABLE `prescricao`
  ADD CONSTRAINT `prescricao_ibfk_1` FOREIGN KEY (`agendamento_id`) REFERENCES `agendamento` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Limitadores para a tabela `sinais`
--
ALTER TABLE `sinais`
  ADD CONSTRAINT `sinais_ibfk_1` FOREIGN KEY (`agendamento_id`) REFERENCES `agendamento` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
